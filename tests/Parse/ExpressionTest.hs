...
tests =
    ...
    , testGroup "if statement"
        ...
        , example "comments" "if{-A-}x{-B-}then{-C-}y{-D-}else{-E-}if{-F-}x'{-G-}then{-H-}y'{-I-}else{-J-}z" $ at 1 1 1 78 (If (Commented [BlockComment ["A"]] (at 1 8 1 9 (Var (VarRef "x"))) [BlockComment ["B"]],False,Commented [BlockComment ["C"]] (at 1 23 1 24 (Var (VarRef "y"))) [BlockComment ["D"]]) [([BlockComment ["E"]],(Commented [BlockComment ["F"]] (at 1 45 1 47 (Var (VarRef "x'"))) [BlockComment ["G"]],False,Commented [BlockComment ["H"]] (at 1 61 1 63 (Var (VarRef "y'"))) [BlockComment ["I"]]))] ([BlockComment ["J"]],at 1 77 1 78 (Var (VarRef "z"))))
