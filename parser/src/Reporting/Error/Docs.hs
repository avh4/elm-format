...
toReport err = case err of
  ...
  OnlyInDocs name suggestions -> Report.simple
    "DOCUMENTATION ERROR"
    (  "Your module documentation includes `"
    ++ name
  ...
  OnlyInExports names -> Report.simple
    "DOCUMENTATION ERROR"
