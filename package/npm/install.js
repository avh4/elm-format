...
var versions = packageInfo.version.match(/^(\d+\.\d+\.\d+)-elm(\d+\.\d+\.\d+).*$/);
var binVersion = versions[1];
var elmVersion = versions[2];
...
var url = "https://dl.bintray.com/elmlang/elm-format/"
  + elmVersion + "/" + binVersion + "/" + filename;
...
var errorMessage = "Unfortunately, there are no elm-format " + binVersion + " binaries available for Elm " + elmVersion + " on your operating system and architecture.\n\nIf you would like to build Elm from source, there are instructions at https://github.com/elm-lang/elm-platform#build-from-source\n";
