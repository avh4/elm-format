...
tar zxvf "elm-format-0.17-${VERSION}-win-i386.tgz"
zip "elm-format-0.17-${VERSION}-win-i386.zip" elm-format.exe
...
for i in elm-format-{0.17,0.18}-${VERSION}-{mac-x64.tgz,win-i386.zip,linux-x64.tgz}; do
