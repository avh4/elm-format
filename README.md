...
[![latest version: 0.5.1-alpha](https://img.shields.io/badge/version-0.5.1--alpha-blue.svg)](https://github.com/avh4/elm-format/releases/tag/0.5.1-alpha)
...
## Installation [![(latest version: 0.5.1-alpha)](https://img.shields.io/badge/version-0.5.1--alpha-blue.svg)](https://github.com/avh4/elm-format/releases/tag/0.5.1-alpha)
...
(To upgrade your Elm 0.17 project to Elm 0.18, see the [Elm 0.18 upgrade guide](https://github.com/elm-lang/elm-platform/blob/master/upgrade-docs/0.18.md).)
 ...
 - Mac: [download](https://github.com/avh4/elm-format/releases/download/0.5.1-alpha/elm-format-0.18-0.5.1-alpha-mac-x64.tgz)
 - Linux: [download](https://github.com/avh4/elm-format/releases/download/0.5.1-alpha/elm-format-0.18-0.5.1-alpha-linux-x64.tgz)
 - Windows: [download](https://github.com/avh4/elm-format/releases/download/0.5.1-alpha/elm-format-0.18-0.5.1-alpha-win-x64.zip)

### For Elm 0.17

 - Mac: [download](https://github.com/avh4/elm-format/releases/download/0.5.1-alpha/elm-format-0.17-0.5.1-alpha-mac-x64.tgz)
 - Linux: [download](https://github.com/avh4/elm-format/releases/download/0.5.1-alpha/elm-format-0.17-0.5.1-alpha-linux-x64.tgz)
 - Windows: [download](https://github.com/avh4/elm-format/releases/download/0.5.1-alpha/elm-format-0.17-0.5.1-alpha-win-x64.zip)
