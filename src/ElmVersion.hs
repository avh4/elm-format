...
parse versionString = case versionString of
  "0.17" -> Right Elm_0_17
  "0.18" -> Right Elm_0_18
  "0.19" -> Right Elm_0_19
  _      -> Left
    (  "Invalid Elm version \""
    ++ versionString
    ++ "\".  Supported versions are 0.18, 0.19"
    )


syntax_0_19_disallowApostropheInVars :: ElmVersion -> Bool
syntax_0_19_disallowApostropheInVars elmVersion = case elmVersion of
  Elm_0_16         -> False
  Elm_0_17         -> False
...
style_0_19_stringEscape elmVersion = case elmVersion of
  Elm_0_16         -> False
  Elm_0_17         -> False
  Elm_0_18         -> False
  Elm_0_18_Upgrade -> False
...
style_0_19_cannotExposeOpenListing elmVersion = case elmVersion of
  Elm_0_16         -> False
  Elm_0_17         -> False
  Elm_0_18         -> False
  Elm_0_18_Upgrade -> False
